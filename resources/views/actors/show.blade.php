...
@section('content')
        ...
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
                        ...
                        <li>
                            <a href="{{ $social['facebook'] }}" target="_blank" title="Facebook">
                                <svg class="fill-current text-gray-400 hover:text-white w-6" viewBox="0 0 448 512">
                                    <path d="M448 56.7v398.5c0 13.7-11.1 24.7-24.7 24.7H309.1V306.5h58.2l8.7-67.6h-67v-43.2c0-19.6
                                    5.4-32.9 33.5-32.9h35.8v-60.5c-6.2-.8-27.4-2.7-52.2-2.7-51.6 0-87 31.5-87 89.4v49.9h-58.4v67.6h58.4V480H24.7C11.1
                                    480 0 468.9 0 455.3V56.7C0 43.1 11.1 32 24.7 32h398.5c13.7 0 24.8 11.1 24.8 24.7z"></path>
                                </svg>
                            </a>
                        </li>
                    @endif
                        ...
                        <li class="ml-6">
                            <a href="{{ $social['instagram'] }}" target="_blank" title="Instagram">
                                <svg class="fill-current text-gray-400 hover:text-white w-6" viewBox="0 0 448 512">
                                    ...
                                    9.9 67.7 36.2 93.9s58 34.4 93.9 36.2c37 2.1 147.9 2.1 184.9 0 35.9-1.7 67.7-9.9 93.9-36.2
                        ...
                        <li class="ml-6">
                            <a href="{{ $social['twitter'] }}" target="_blank" title="Twitter">
                                <svg class="fill-current text-gray-400 hover:text-white w-6" viewBox="0 0 512 512">
                                    ...
                                    104.934-104.934 30.213 0 57.502 12.67 76.67 33.137 23.715-4.548 46.456-13.32 66.599-25.34-7.798 24.366-24.366 44.833-46.132
                                    57.827 21.117-2.273 41.584-8.122 60.426-16.243-14.292 20.791-32.161 39.308-52.628 54.253z"></path>
                                </svg>
                            </a>
                        </li>
                    @endif
            ...
            <div class="md:ml-24">
                ...
                <div class="flex flex-wrap items-center text-gray-400 text-sm">
                    <span class="fill-current text-orange-500 w-4"><i class="fa fa-birthday-cake" aria-hidden="true"></i></span>
                    <span class="ml-2">{{ $actor['birthday'] }} (возраст {{ $actor['age'] }}) in {{ $actor['place_of_birth'] }}</span>
                </div>
                <p class="text-gray-300 mt-8">
                    {{ $actor['biography'] }}
                </p>

                <h4 class="font-semibold mt-12">Известность за</h4>

                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
                    @foreach($knowForMovies as $movie)
                        <div class="mt-4">
                            <a href="{{ $movie['linkToPage'] }}"><img src="{{ $movie['poster_path'] }}" alt="poster" class="w-64 md:w-96"></a>
    ...
    <div class="credits border-b border-gray-800">
        <div class="container mx-auto px-4 py-16">
            <h2 class="text-4xl font-semibold">Снялся в фильмах</h2>
